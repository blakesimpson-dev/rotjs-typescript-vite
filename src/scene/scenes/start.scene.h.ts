...
import { drawRect, removeRotColorNotation, renderAsciiAsset } from '@/utils'
...
export class StartScene implements Scene {
  ...
  render(display: RotDisplay): void {
    const viewWidth = 96
    const viewHeight = 40
    // const viewWidth = Game.instance.viewDisplay._options.width
    // const viewHeight = Game.instance.viewDisplay._options.height
